...
nlevels = 5
mesh = MeshTri.init_circle(nlevels)

element = {'u': ElementTriRT1()#ElementVector(ElementTriP1B()),
           'p': ElementTriP1()}
...
if __name__ == '__main__':
    ...
    pressures = pressure[basis['p'].nodal_dofs].flatten()
    pmean = 0.0
    for px in pressures:
        pmean += px
    pmean /= len(pressures)
